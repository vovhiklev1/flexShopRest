        ...
        var directive = {
            ...
            controller: ['$state', '$scope', '$rootScope', function ($state, $scope, $rootScope) {
                ...
                function action() {
                    ...
                    if ($scope.item.actionType == 'CHANGE_CURR_BAR') {
                        ...
                        $state.go("view.subs.desktop", {view: $stateParams.view, type: $scope.item.action}, {inherit: false});
                        ...
                        /*switch ($scope.item.action) {
                            case 'desktop':
                                (function () {*/
                                 //   $state.go("view.subs.desktop", {type: $scope.item.action}, {inherit: true});
